...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(border-color ((,class (:background "grey40"))))
   `(default ((,class (:background "grey50" :foreground "black"))))
   `(fringe ((,class (:background "grey50"))))
   `(mode-line ((,class (:box (:line-width -1 :style released-button)
			 :background "grey40" :foreground "#2E3436"))))
   `(mode-line-inactive ((,class (:foreground "#C6C6C6" :background ,"white"))))
   `(header-line ((,class (:foreground "grey40" :background "black"))))
   ...
   `(widget-button ((,class (:bold t :background "grey40" :foreground "#0084C8"))))

   `(success ((,class (:bold t :foreground "#4E9A06"))))
   `(warning ((,class (:foreground "#CE5C00"))))
   `(error ((,class (:foreground "DeepPink"))))

   `(font-lock-builtin-face ((,class (:foreground "#A020F0"))))
   `(font-lock-constant-face ((,class (:foreground "LimeGreen"))))
   `(font-lock-comment-face ((,class (:foreground "SlateBlue4"))))
   `(font-lock-function-name-face ((,class (:foreground "#A020F0" :bold t))))
   `(font-lock-keyword-face ((,class (:bold t :foreground "chartreuse3"))))
   `(font-lock-string-face ((,class (:foreground "LimeGreen"))))
   `(font-lock-type-face ((,class (:foreground "DarkOrchid3" :bold t))))
   `(font-lock-variable-name-face ((,class (:foreground "DeepSkyBlue3" :bold t))))
   `(font-lock-warning-face ((,class (:foreground "DeepPink" :bold t))))
