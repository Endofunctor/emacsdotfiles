...
(defun color-theme-purpdrank-neon ()
  " :3 "
  (interactive)
  (color-theme-install
   '(color-theme-purpdrank-neon
     ...
     (wnka-magenta-face ((t (:foreground "#A6E22E"))))
     (wnka-blue-face ((t (:foreground "cyan3"))))
     (wnka-darkgrey-face ((t (:foreground "#75715E"))))
     (wnka-green-face ((t (:foreground "#A6E22E"))))
     (wnka-yellow-face ((t (:foreground "DarkOrchid3"))))
     (wnka-orange-face ((t (:foreground "DarkOrchid3"))))
     ...
     (font-lock-function-name-face ((t (:bold :inherit wnka-green-face))))
