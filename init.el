...
(add-to-list 'default-frame-alist '(font . "Menlo for Powerline:pixelsize=13:foundry=bitstream:weight=normal:slant=normal:width=normal:spacing=100:scalable=true:antialias=true"))
(set-face-attribute 'default t :font "Menlo for Powerline:pixelsize=13:foundry=bitstream:weight=normal:slant=normal:width=normal:spacing=100:scalable=true:antialias=true")
;;(add-to-list 'default-frame-alist '(font . "DejaVu Sans Mono:antialias=1:pixelsize=12"))
;;(set-face-attribute 'default t :font "DejaVu Sans Mono:antialias=1:pixelsize=12")
;;(add-to-list 'default-frame-alist '(font . "Bitstream Vera Sans Mono:pixelsize=12:weight=bold:slant=normal:width=normal:spacing=100:scalable=true:antialias=true"))
;;(set-face-attribute 'default t :font "Bitstream Vera Sans Mono:pixelsize=12:weight=bold:slant=normal:width=normal:spacing=100:scalable=true:antialias=true")
(global-linum-mode 0)
...
(add-to-list 'load-path "~/.emacs.d/vendor/nim-mode")
(add-to-list 'load-path "~/.emacs.d/vendor/gist.el")
(add-to-list 'load-path "~/.emacs.d/vendor/tabulated-list.el")
